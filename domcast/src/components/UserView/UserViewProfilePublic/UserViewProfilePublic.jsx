...
import './UserViewProfilePublic.css';

const UserViewProfilePublic = ({ profilePic, firstName, lastName, nickname, lab, bio, skills, interests, privacy }) => {
...
export default UserViewProfilePublic;